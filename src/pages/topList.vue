...
<script>
import { getTopList, getPersonalized } from "api/index.js";
...
export default {
  ...
  methods: {
    async getList() {
      ...
      let result1 = await getPersonalized();
      this.list = result.list.filter((item) => item.ToplistType);
      this.hotList = result1.result;
    },
  },
};
</script>
